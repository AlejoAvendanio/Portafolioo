...
export default function About() {
  return (
    <div className='about'>
        ...
        <span>
            <p>Soy un estudiante de Ingeniería en Sistemas de la universidad táctica nacional, recibido del bootcamp Soy Henry, con muchas ganas de afrontar nuevos desafíos e ingresar en el mundo laboral para poder proporcionar todos mis conocimientos y expandirlos aún más!
            </p>
        </span>
